# Generated by Django 4.1.3 on 2022-12-08 17:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='delivery.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, null=True)),
                ('photo', cloudinary.models.CloudinaryField(default='https://res.cloudinary.com/dkcivjz16/image/upload/v1670318972/moto%20foods/rowan-freeman-clYlmCaQbzY-unsplash_saxitz.jpg', max_length=255, verbose_name='photo')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='delivery.product')),
            ],
        ),
        migrations.CreateModel(
            name='Admin',
            fields=[
                ...
                ('approval', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approval', to='delivery.approvals')),
                ('user', models.OneToOneField(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
