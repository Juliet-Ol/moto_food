    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='vendor_approval', to='delivery.approvals')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(blank=True, null=True)),
                ('photo', cloudinary.models.CloudinaryField(default='', max_length=255, verbose_name='image')),
                ('approval', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='customer_approval', to='delivery.approvals')),
                ('user', models.OneToOneField(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
